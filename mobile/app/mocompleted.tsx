...
const MOCompleted = () => {
  ...
  const delivery = [
    { 
      id: 1, 
      timestamp: "16.07.2022, 20:53", 
      tracking: "M2Z4-VVY2",
      image: require("../assets/images/nurofen.jpeg"),
      name: "Nurofen Junior Fiebersaft Erbeer 4...",
      volume: "150ml",
      boughtqt: "x1",
      price: "160.00",
      quantity: 1,
    ...
    { 
      id: 2, 
      timestamp: "29.06.2022, 15:18", 
      tracking: "VSLR-298A",
      image: require("../assets/images/ratiopharm.jpeg"),
      name: "Paracetamol-Ratiopharm 500mg...",
      volume: "10pcs",
      boughtqt: "x7",
      price: "53.70",
      quantity: 7,
        ...
        {delivery.map((item) => (
          <View key={item.id} style={styles.deliveryCard}>
            <View style={styles.deliveryHeader}>
              ...
              <Text style={styles.deliveryDate}>Delivered on {item.timestamp}</Text>
